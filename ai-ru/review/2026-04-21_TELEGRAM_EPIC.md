...
| **2.2** 🚧 | **Перенос базовых экранов.** Scene'ы Home / Мои метки / Детали метки / Уведомления (список) / Настройки каналов / Профиль. HTML-форматирование, эмодзи, навигация «← Назад» и «🏠 Главное». Edit-in-place. PNG вместо PDF для QR. | Да, радикально | [spec](2026-04-21_TG_2.2_BASIC_SCREENS.md) |
