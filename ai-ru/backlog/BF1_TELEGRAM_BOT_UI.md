...
> **⚠️ Скоуп пересмотрен 2026-04-21.** Изначально BF1 = «рефакторинг + HTML/эмодзи». По итогам брейнсторма превращён в эпик: **бот = копия мобильного приложения** (те же экраны, команды, переходы) + канал уведомлений + задел под Phase 5 (парковка). Полный план — в **[review/2026-04-21_TELEGRAM_EPIC.md](../review/2026-04-21_TELEGRAM_EPIC.md)**. Первый под-спек — **[review/2026-04-21_TG_2.1_ARCHITECTURE.md](../review/2026-04-21_TG_2.1_ARCHITECTURE.md)**.
