 ...
 * Alias for UserBuilder for more explicit naming.
 */
public class SecurityUserBuilder {
    ...
    public SecurityUserBuilder withId(Long id) {
        this.id = id;
        return this;
    }

    public SecurityUserBuilder withTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }

    public SecurityUserBuilder withRole(Role role) {
        this.role = role;
        return this;
    }

    public SecurityUserBuilder withAuthId(Long authId) {
        this.authId = authId;
        return this;
    }

    public SecurityUserBuilder asAdmin() {
