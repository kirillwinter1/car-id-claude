...
| [ai-ru/ROADMAP.md](ai-ru/ROADMAP.md) | Верхнеуровневый план развития (5 фаз) |
| [ai-ru/FEATURES.md](ai-ru/FEATURES.md) | Индекс реализованных фич + бэклог |
...
**Бизнес-контекст (внешне):** соседний проект [`../ozon-workspace/`](../ozon-workspace/) — аналитика продаж QR-стикеров на Ozon через MCP-сервер. При продуктовых решениях учитывать, не коммитить туда.
